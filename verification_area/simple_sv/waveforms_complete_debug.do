...
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_2/u
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_2/v
add wave -noupdate -divider {Internal Values}
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_2/range_1
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_2/range_2
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_2/low_1
...
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_3/S
add wave -noupdate -divider {Stage [3,4,5] - s0}
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_3/C_s0
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_3/M_s0
add wave -noupdate -divider {Stage [3,4,5] - s8}
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_3/M_s8
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_3/C_s8
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_3/low_s8
add wave -noupdate -divider {Stage [3,4,5] - Comp}
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_3/COMP_mux_2
add wave -noupdate /tb_arith_encoder/arith_encoder/state_pipeline_3/COMP_mux_3
TreeUpdate [SetDefaultTree]
