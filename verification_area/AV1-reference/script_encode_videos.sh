...
# video 6 - YachtRide_3840x2160_120fps_420_10bit_YUV
echo "Executing video 6 - CQ 20"
./aomenc --verbose --psnr --frame-parallel=0 --tile-columns=0 --passes=2 --cpu-used=8 --threads=10 --kf-min-dist=1000 --kf-max-dist=1000 --end-usage=q --lag-in-frames=19 --cq-level=20 --limit=120 -o /media/tulio/HD/y4m_files/video_coded/video_codificado.ivf /media/tulio/HD/y4m_files/YachtRide_3840x2160_120fps_420_10bit_YUV.y4m
sync
mv arith_analysis/main_data.csv /media/tulio/HD/y4m_files/generated_files/cq_20/YachtRide_3840x2160_120fps_420_10bit_YUV_cq20_main_data.csv
mv arith_analysis/complete_final_bitstream.csv /media/tulio/HD/y4m_files/generated_files/cq_20/YachtRide_3840x2160_120fps_420_10bit_YUV_cq20_final_bitstream.csv
echo "Executing video 6 - CQ 55"
./aomenc --verbose --psnr --frame-parallel=0 --tile-columns=0 --passes=2 --cpu-used=8 --threads=10 --kf-min-dist=1000 --kf-max-dist=1000 --end-usage=q --lag-in-frames=19 --cq-level=55 --limit=120 -o /media/tulio/HD/y4m_files/video_coded/video_codificado.ivf /media/tulio/HD/y4m_files/YachtRide_3840x2160_120fps_420_10bit_YUV.y4m
sync
mv arith_analysis/main_data.csv /media/tulio/HD/y4m_files/generated_files/cq_55/YachtRide_3840x2160_120fps_420_10bit_YUV_cq55_main_data.csv
mv arith_analysis/complete_final_bitstream.csv /media/tulio/HD/y4m_files/generated_files/cq_55/YachtRide_3840x2160_120fps_420_10bit_YUV_cq55_final_bitstream.csv
