...
add wave -noupdate -color {Cornflower Blue} /tb_arith_encoder_entire_file/arith_encoder/control/reset_ctrl
add wave -noupdate -divider Control
add wave -noupdate /tb_arith_encoder_entire_file/arith_encoder/control/pipeline_reg_1_2
add wave -noupdate /tb_arith_encoder_entire_file/arith_encoder/control/pipeline_reg_final
add wave -noupdate -divider {Stage 1 - Input}
add wave -noupdate -color {Cornflower Blue} -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_1/FL
add wave -noupdate -color {Cornflower Blue} -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_1/FH
add wave -noupdate -color {Cornflower Blue} -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_1/SYMBOL
add wave -noupdate -color {Cornflower Blue} -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_1/NSYMS
add wave -noupdate -divider {Stage 1 - Outputs}
add wave -noupdate -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_1/COMP_mux_1
add wave -noupdate -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_1/lut_u_out
add wave -noupdate -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_1/lut_v_out
add wave -noupdate -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_1/UU
add wave -noupdate -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_1/VV
add wave -noupdate -divider {Stage 2 - Inputs}
add wave -noupdate -color {Cornflower Blue} -radix binary /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_2/symbol
add wave -noupdate -color {Cornflower Blue} -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_2/bool
add wave -noupdate -color {Cornflower Blue} -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_2/UU
add wave -noupdate -color {Cornflower Blue} -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_2/VV
add wave -noupdate -color {Cornflower Blue} -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_2/lut_u
...
add wave -noupdate -color Gold -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_2/range_2
add wave -noupdate -color Gold -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_2/range_bool
add wave -noupdate -color Gold -radix unsigned /tb_arith_encoder_entire_file/arith_encoder/state_pipeline_2/range_not_bool
